...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { address: @place.address, city: @place.city, district: @place.district, name: @place.name, phone: @place.phone, uf: @place.uf, website: @place.website } }
